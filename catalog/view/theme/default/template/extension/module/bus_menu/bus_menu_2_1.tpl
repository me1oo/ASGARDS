...
<?php } ?>
<div class="bus-menu-style-2-1 row<?php echo ($lg_status ? false : ' hidden-lg'); ?><?php echo ($md_status ? false : ' hidden-md'); ?><?php echo ($sm_status ? false : ' hidden-sm'); ?><?php echo ($xs_status ? false : ' hidden-xs'); ?>">
