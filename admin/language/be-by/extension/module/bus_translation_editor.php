...
// Heading
$_['heading_title']                              = '<b>Рэдактар перакладу <span style="color:limegreen">Full</span></b> v' . (isset($this->data['bus_translation_editor_version']) ? $this->data['bus_translation_editor_version'] : '1.0');
...
// Column
$_['column_name']                                = 'Назва зменнай';
$_['column_value']                               = 'Гэтае значэньне';
...
$_['text_info']                                  = 'Бясплатная версія для OpenCart.Pro, ocStore і MaxyStore';
$_['text_search']                                = 'Пошук';
...
// Entry
$_['entry_store']                                = 'Крама';
$_['entry_language_files']                       = 'Моўныя файлы';
$_['entry_editor']                               = 'Рэдактар';
$_['entry_status']                               = 'Статус';

// Help
$_['help_store']                                 = 'Крама';
$_['help_language_files']                        = 'Адлюстроўваюцца моўныя файлы ўсіх моў. Пры запаўненні перакладу, калі файл не існуе, то ён будзе аўтаматычны створаны.';
$_['help_search']                                = 'Шукае ў моўных файлах па пераменным і значэнняў.';
$_['help_editor']                                = 'Рэдактар';
$_['help_value']                                 = 'Выконвайце цэласнасць двукоссяў і экрануе іх, калі трэба вывесці ў перакладзе.';
